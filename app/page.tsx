...
const CARDS = [
  { href: "/catalogs", color: "var(--wl-2)", title: "Download", body: "Download the photometry, photo-z variants, flags, PSFs, segmentation map, and templates." },
  { href: "/search",   color: "var(--wl-3)", title: "Query",    body: "Find sources by ID or position, run queries on redshift & magnitude, view bio plots, export subsets." },
];

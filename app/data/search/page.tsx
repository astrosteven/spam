  ...
  return (
    <div className="card-bright" style={{ padding: "1.25rem", marginBottom: "12px" }}>
      ...
      <div style={{ display: "flex", gap: "1.5rem", flexWrap: "wrap", alignItems: "flex-start" }}>
        {/* SED */}
        <div>
          <div style={{ fontSize: "0.7rem", color: "var(--text-dim)", fontFamily: "'JetBrains Mono', monospace", marginBottom: "4px" }}>SED</div>
          <SEDPlot src={src} />
        </div>
        {/* P(z) */}
        <div>
          <div style={{ fontSize: "0.7rem", color: "var(--text-dim)", fontFamily: "'JetBrains Mono', monospace", marginBottom: "4px" }}>P(z)</div>
          <PZPlot zgrid={src.zgrid} pz={pzNorm} za={za} zgridLowz={src.zgridLowz} pzLowz={pzLowzNorm} />
        </div>
        {/* Info table */}
        <div style={{ flex: 1, minWidth: "160px" }}>
          <div style={{ fontSize: "0.7rem", color: "var(--text-dim)", fontFamily: "'JetBrains Mono', monospace", marginBottom: "8px" }}>PROPERTIES</div>
            ...
            <tbody>
              {[
                ...
                <tr key={label} style={{ borderBottom: "1px solid var(--border)" }}>
                  <td style={{ padding: "3px 0", color: "var(--text-dim)", fontFamily: "'JetBrains Mono', monospace", fontSize: "0.75rem", paddingRight: "12px" }}>{label}</td>
                  <td style={{ padding: "3px 0", color: "var(--text)", fontFamily: "'JetBrains Mono', monospace" }}>{val}</td>
                </tr>
              ))}
            </tbody>
          </table>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontFamily: "'JetBrains Mono', monospace", fontSize: "0.8rem" }}>
              ...
              <tbody>
                {queryRows.map((r, i) => {
                  ...
                  {open && (
                    <tr ref={cardRef}>
                      <td colSpan={5} style={{ padding: "0.5rem 0.75rem 1rem", background: "rgba(47,125,209,0.04)" }}>

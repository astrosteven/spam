...
type QueryRow = { fc: FieldConfig; id: number; za: number | null; m444: number | null; zspec: number | null; selected: number | null; extra: (number | string | null)[] };
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontFamily: "'JetBrains Mono', monospace", fontSize: "0.8rem" }}>
              <thead>
                <tr style={{ background: "rgba(47,125,209,0.07)" }}>
                  {["ID", "z_a", "m₄₄₄", "zspec", ...queryCols, "selected", "map", ""].map((h, i) => (
              ...
              <tbody>
                {queryRows.map((r, i) => {
                  ...
                  {open && (
                    <tr ref={cardRef}>
                      <td colSpan={6 + queryCols.length} style={{ padding: "0.5rem 0.75rem 1rem", background: "rgba(47,125,209,0.04)" }}>
